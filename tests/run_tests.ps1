...
try {
  ...
  $compileHarness = & gcc -Wall -Wextra -std=c99 -g -O0 -D_GNU_SOURCE tests/relocation_test.c src/common.c src/lexer/lexer.c src/error/error_reporter.c src/error/diag_style.c src/linker/coff_reader.c src/linker/link_object.c src/linker/elf_reader.c src/linker/symbol_resolve.c src/linker/relocation.c src/codegen/binary_emitter.c src/codegen/elf_emitter.c -Isrc -Isrc/codegen -o $relocationExe 2>&1 | Out-String
  if ($LASTEXITCODE -ne 0) {
...
try {
  ...
  $compileHarness = & gcc -Wall -Wextra -std=c99 -g -O0 -D_GNU_SOURCE tests/pe_emitter_test.c src/common.c src/lexer/lexer.c src/error/error_reporter.c src/error/diag_style.c src/linker/coff_reader.c src/linker/link_object.c src/linker/elf_reader.c src/linker/symbol_resolve.c src/linker/relocation.c src/linker/pe_emitter.c src/linker/import_lib.c src/runtime/verify_owned.c src/codegen/binary_emitter.c src/codegen/elf_emitter.c -Isrc -Isrc/codegen -o $peEmitterExe 2>&1 | Out-String
  if ($LASTEXITCODE -ne 0) {
