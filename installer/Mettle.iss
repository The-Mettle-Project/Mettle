...
; Build locally:
;   iscc Mettle.iss
; Stamp a version: iscc /DMyAppVersion=0.16.1 Mettle.iss
...
; #211c14 in light mode, #16181d in dark. The banner and header marks in art\
; are generated by render_wizard_art.py, one image per display-scaling step so
; nothing is upscaled. Re-run that script after changing the mark or the
; version; the guard below fails the build if the art is stale.
;
...
; One image per scaling step (100/125/150/200%); Setup picks the closest.
WizardImageFile=art\WizardImage-164x314.png,art\WizardImage-205x393.png,art\WizardImage-246x471.png,art\WizardImage-328x628.png
WizardImageFileDynamicDark=art\WizardImageDark-164x314.png,art\WizardImageDark-205x393.png,art\WizardImageDark-246x471.png,art\WizardImageDark-328x628.png
WizardSmallImageFile=art\WizardSmallImage-55x55.png,art\WizardSmallImage-69x69.png,art\WizardSmallImage-83x83.png,art\WizardSmallImage-110x110.png
WizardSmallImageFileDynamicDark=art\WizardSmallImageDark-55x55.png,art\WizardSmallImageDark-69x69.png,art\WizardSmallImageDark-83x83.png,art\WizardSmallImageDark-110x110.png
WizardImageBackColor=#f2ebd8
WizardImageBackColorDynamicDark=#16181d
WizardSmallImageBackColor=#f2ebd8
WizardSmallImageBackColorDynamicDark=#16181d
WizardBackColor=#f2ebd8
WizardBackColorDynamicDark=#16181d
LicenseFile=..\LICENSE
...
WelcomeLabel2=This will install Mettle on your computer.%n%nMettle is a systems language that compiles straight to native code through its own backend and linker, targeting x86-64, ARM64, NVIDIA PTX, and SPIR-V. Setup installs the compiler, the standard library, the runtime, and the documentation.%n%nIt is recommended that you close other applications before continuing.%n%nClick Next to continue, or Cancel to exit Setup.
