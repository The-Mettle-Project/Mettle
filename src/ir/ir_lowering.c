...
//   goto case_label;
//   skip:
static int ir_emit_switch_range_dispatch(IRLoweringContext *context,
                                         IRFunction *function,
...
static void ir_defer_stack_free(IRDeferStack *stack) {
  if (!stack) {
    return;
  }
...
static int ir_defer_capture_call(IRLoweringContext *context,
